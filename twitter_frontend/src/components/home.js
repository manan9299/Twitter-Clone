                        ...
                        <div className="card-fluid shadow-sm" id="side-nav">  
                             ...
                             <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link font-weight-bold" id='preparing'  href="/findHashTags" >Explore</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link font-weight-bold" id='pastorders' href="/messageInbox">Messaging</a>
                                </li>
                                <li className="nav-item">
