...
const CommentTweet = (props) => {
    ...
    const handleReplyTweet = async (e) => {
        ...
        axios.post(defaultValues.serverURI+'/tweet/replyTweet',{username:props.username,tweetId:props.tweet._id,content:reply})
            .then(res => {
    ...
    const handleUpdateLikes = () => {
        axios.post(defaultValues.serverURI+'/tweet/updateLikes', { likes: likes, username:props.username})
            .then(res => {
